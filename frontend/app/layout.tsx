...
export const metadata: Metadata = {
  ...
  icons: {
    icon: '/images/logo/AGI Villa icon.jpg',
    apple: '/images/logo/AGI Villa icon.jpg',
    shortcut: '/images/logo/AGI Villa icon.jpg',
  },
  ...
  openGraph: {
    ...
    images: [
      {
        url: '/images/logo/AGI Villa icon.jpg',
        width: 1200,
        height: 630,
...
export default function RootLayout({
  ...
  const jsonLd = {
    ...
    url: 'https://agivilla.com',
    logo: 'https://agivilla.com/images/logo/AGI Villa icon.jpg',
    sameAs: [
      // 添加实际的社交媒体链接
